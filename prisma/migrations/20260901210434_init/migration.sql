...
-- CreateIndex
CREATE INDEX "Experience_isPublished_order_idx" ON "Experience"("isPublished", "order");

-- CreateIndex
CREATE INDEX "Education_isPublished_order_idx" ON "Education"("isPublished", "order");
...
-- CreateIndex
CREATE INDEX "Certificate_isPublished_order_idx" ON "Certificate"("isPublished", "order");

-- CreateIndex
CREATE INDEX "SocialLink_isPublished_order_idx" ON "SocialLink"("isPublished", "order");
